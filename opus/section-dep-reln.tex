...
\item \textit{He did it in \underline{a third of} the time it took me.} \label{ex:third_of} \citep[Ch. 5.19]{quirk:1985}} 
...
\enumsentence{\textit{El aire contiene \underline{el doble de} óxido de nitrógeno que en Washington.} \label{ex:doble_de} \citep[Ch. 10.14]{butt}}
...
{\textit{`a bathing suit'} \citep[Ch. 34.7]{butt}}}
