...
\xybarnode{father} &
\xybarnode{gave} 
\xybarconnect(UL,U){-1}"_{\small\nf nsubj}"
\xybarconnect(UR,U){1}"^{\small\nf iobj}"
\xybarconnect(D,D){3}"_{\small\nf dobj}"&
\xybarnode{him} &
\xybarnode{the} &
\xybarnode{rest} &
\xybarnode{of} &
...
\xybarnode{appointed} 
\xybarconnect(U,U){-1}"_{\small\nf nsubj}"
\xybarconnect(D,D){5}"_{\small\nf xcomp}"&
\xybarnode{him} &
\xybarnode{the} &
\xybarnode{deputy} &
\xybarnode{Prime} &
\xybarnode{Minister}
\xybarconnect(U,U){-4}"_{\small\nf nsubj}"&
\ldots
}
\nfitem\xytext{
\xybarnode{That} &
