...
\eenumsentence{
\singlespacing
\item \textit{Compelled to take stern measures, the administration lost popularity.} 
\item \textit{?Bound to take stern measures, the administration lost popularity.} 
\item \textit{Unable/Unwilling to resist, Matilda agreed to betray her country.}
\item \textit{?Able/?Willing to take resist, Matilda declined to betray her country.}\\ (\citealt[footnote, p. 144]{quirk:1985})}
...
\eenumsentence{
\item \shortex{5}
{Las&muestras&les&serán&devueltas.}
{The&samples&to-you (pl.)&will-be&returned.}
{}
\item \shortex{5}
{Se&les&devolverán&las&muestras.}
{&to-you (pl.)&will-return&the&samples.}
{`The samples will be returned to you.'}\\ \citep[p. 402,8]{butt}}
